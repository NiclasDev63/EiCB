...
public class CodeGenerator extends AstNodeBaseVisitor<Instruction, Void> {
	...
	public Instruction visitForEachLoop(ForEachLoop forEachLoop, Void __) {
		...
		IteratorDeclaration it = forEachLoop.iteratorDeclaration;

		it.setLocalBaseOffset(size * -1);
        ...
        forEachLoop.structExpression.accept(this, null);
		visit(forEachLo@@op.structExpression);
        ...
        int iterator  = forEachLoop.iteratorDeclaration.getLocalBaseOffset();
